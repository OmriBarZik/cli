...
* **arborist:** when replacing a Link with a Node, make sure to remove the Link target from the root ([3d96494](https://github.com/OmriBarZik/cli/commit/3d964940f410052918e37a9b05818fe9dc4cd86a))
